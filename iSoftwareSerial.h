...
private:
  ...
  volatile const uint8_t *const in_pin_reg;
  volatile uint8_t *const in_int_reg;
  const uint8_t in_port_mask;
  const uint8_t in_int_mask;
  const uint8_t out;
  const uint8_t out_port;
  volatile uint8_t *const out_port_reg;
  const uint8_t out_port_mask;
